...
const u32 gObjectEventPic_EnemyBidoof[] = INCGFX_U32("graphics/pokemon/bidoof/overworld.png", ".4bpp", "-mwidth 4 -mheight 4");
const u16 gObjectEventPal_EnemyBidoof[] = INCGFX_U16("graphics/pokemon/bidoof/overworld_normal.pal", ".gbapal");
